            ...
            <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
                @php
                    $navItems = [
                        ...
                        ['type' => 'header', 'label' => 'Manajemen Proyek'],
                        ...
                        ['route' => 'admin.packages.index', 'label' => 'Paket Layanan', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>'],
                        ...
                        ['type' => 'header', 'label' => 'Logikraf Payment Hub'],
                        ['route' => 'admin.payment-hub.saas-apps', 'label' => 'Aplikasi Terintegrasi', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/>'],
                        ...
                        ['route' => 'admin.payment-hub.disbursements', 'label' => 'Penarikan Dana', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
                        ...
                        ['route' => 'admin.transactions.index', 'label' => 'Laporan Keuangan', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>'],
                        ['route' => 'admin.time-tracking.index', 'label' => 'Time Tracking', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
                ...
                @foreach($navItems as $item)
                    @if(isset($item['type']) && $item['type'] === 'header')
                        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-3 pt-6 pb-2 text-xs font-semibold text-white/40 uppercase tracking-wider" x-transition>
                            {{ $item['label'] }}
                        </div>
                        <div x-show="!sidebarOpen && !mobileSidebarOpen" class="w-full border-t border-white/10 my-3"></div>
                    @else

...
var staticPaths = []string{"/", "/solusi", "/paket", "/jasa-pembuatan-aplikasi-web", "/aplikasi-manajemen-perumahan", "/portfolio", "/blog", "/faq", "/tentang-kami", "/kontak", "/kebijakan-refund", "/kebijakan-privasi", "/syarat-ketentuan"}

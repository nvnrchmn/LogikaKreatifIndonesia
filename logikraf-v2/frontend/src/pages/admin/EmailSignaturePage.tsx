...
export default function EmailSignaturePage() {
  ...
  const save = () => { localStorage.setItem('sigcfg', JSON.stringify(cfg)); message.success('Pengaturan disimpan di browser ini') }
      ...
      <Row gutter={16}>
        <Col xs={24} lg={11}>
          ...
          <Space style={{ marginTop: 14 }}>
            <Button type="primary" onClick={save}>Terapkan &amp; Simpan</Button>

...
function WalletNavIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2 2 0 00-2-2H7a2 2 0 01-2-2V5a2 2 0 012-2h13a2 2 0 012 2v7m0 0v7a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2" />
    </svg>
  )
}

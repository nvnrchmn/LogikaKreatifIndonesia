...
func main() {
	...
	admin.Get("/tickets-inbox", handler.AdminTickets)
	admin.Get("/tickets-inbox/:id", handler.AdminTicket)
	admin.Post("/tickets-inbox/:id/replies", handler.AdminReplyTicket)
	admin.Put("/tickets-inbox/:id/status", handler.AdminTicketStatus)

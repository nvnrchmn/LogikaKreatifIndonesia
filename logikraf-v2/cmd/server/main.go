...
func main() {
	...
	admin.Get("/order-tasks", handler.GetOrderTasks)
	admin.Get("/order-tasks/by-order/:orderId", handler.GetOrderTasksByOrder)
	admin.Post("/order-tasks", handler.CreateOrderTask)
	admin.Put("/order-tasks/:id", handler.UpdateOrderTask)
	admin.Delete("/order-tasks/:id", handler.DeleteOrderTask)

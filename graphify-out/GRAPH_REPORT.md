...
## Corpus Check
- 138 files · ~61,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 777 nodes · 926 edges · 100 communities (63 shown, 37 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6850f96`
...
Cohesion: 0.09
Nodes (29): apiGet(), apiPost(), apiPut(), auth(), Activity, AdminDashboardPage(), AnyArr, get() (+21 more)

### Community 2 - "ClientLayout.tsx"
Cohesion: 0.06
Nodes (15): navItems, Invoice, InvoiceItem, mockInvoices, statusColors, mockOrders, Order, statusColors (+7 more)
...
Cohesion: 0.14
Nodes (6): Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, ExampleTest, PackageTest, ServiceTest, TestCase
...
Cohesion: 0.24
Nodes (10): ProtectedRoute(), RequireAdmin(), RequireClient(), AuthContext, AuthContextType, AuthProvider(), useAuth(), AdminLoginPage() (+2 more)

### Community 14 - "PublicLayout.tsx"
Cohesion: 0.18
Nodes (5): Footer(), NavbarProps, Props, Portfolio, HomePage()
...
### Community 16 - "react"
Cohesion: 0.19
Nodes (7): App(), Testimonial, usePageMeta(), Root(), Business, mockBusinesses, react

### Community 17 - "PublicLayout"
Cohesion: 0.17
Nodes (5): PublicLayout(), AboutPage(), Post, Package, Post
...
Cohesion: 0.33
Nodes (8): AdminResourcePage(), auth(), ResourceForm(), ResourceList(), ColumnDef, crudConfigs, FieldDef, ResourceConfig
...
Cohesion: 0.22
Nodes (8): 1. Persiapan Build di Local (Sebelum Upload), 2. Upload File ke Server, 3. Konfigurasi Database & Environment, 4. Setup Storage Symlink (Penting!), 5. Menjalankan Migrasi, 6. Setup Cron Jobs (Task Scheduling), 7. Optimasi Terakhir (Performance), Panduan Deployment logikraf.id (DirectAdmin / Shared Hosting)
...
Cohesion: 0.60
Nodes (4): GetSetting(), Ctx, ListSettings(), SetSetting()
...
### Community 58 - "FaqPage.tsx"
Cohesion: 0.50
Nodes (3): FaqPage(), Gateway, staticFaqs
...
## Knowledge Gaps
- **293 isolated node(s):** `deploy.sh script`, `$schema`, `typescript`, `oxc`, `react/rules-of-hooks` (+288 more)
...
- **Why does `react` connect `react` to `AdminDashboardPage.tsx`, `ClientLayout.tsx`, `AdminLayout.tsx`, `App.tsx`, `PublicLayout.tsx`, `PublicLayout`, `AdminResourcePage.tsx`, `plugins`, `ClientDashboardPage.tsx`, `ReportsPage.tsx`, `ServiceShowcase.tsx`, `ClientOrdersPage.tsx`, `Settings/SettingsPage.tsx`, `ContactPage.tsx`, `FaqPage.tsx`, `BlogPage.tsx`, `PortfolioDetailPage.tsx`, `public/ServicesPage.tsx`, `TermsPage.tsx`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `plugins` connect `plugins` to `react`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `HashPassword()` connect `auth.go` to `payment.go`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `deploy.sh script`, `$schema`, `typescript` to the rest of the system?**
...
- **Should `ClientLayout.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.05591397849462366 - nodes in this community are weakly interconnected._